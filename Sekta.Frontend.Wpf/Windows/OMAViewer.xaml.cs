...
public partial class OMAViewer
    : ReactiveWindow<OMAModelView>,
        System.Windows.Markup.IComponentConnector
{
    ...
    )
    {
        ...
        this.WhenActivated(
            (disposeable) =>
            {
                this.OneWayBind(ViewModel, (vm) => vm.Entries, (v) => v.Items.ItemsSource)
                    .DisposeWith(disposeable);

                this.Bind(ViewModel, (vm) => vm.ApplicationName, (v) => v.ApplicationName.Text)
                    .DisposeWith(disposeable);

                this.Bind(ViewModel, (vm) => vm.AdmxFileName, (v) => v.FileName.Text)
                    .DisposeWith(disposeable);
            }
        );
    }
