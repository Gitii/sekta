        ...
        System.Windows.Markup.IComponentConnector
{
    public MainWindow()
    {
        ...
        this.WhenActivated(
            (disposable) =>
            {
                this.BindCommand(ViewModel, (vm) => vm.ResetSearchTermCommand, (v) => v.ClearSearch)
                ...
                this.Bind(ViewModel, (vm) => vm.CurrentCategory, (v) => v.Categories.SelectedItem)
                    .DisposeWith(disposable);
                ...
                this.Bind(ViewModel, (vm) => vm.CurrentPolicy, (v) => v.Policies.SelectedItem)
                    .DisposeWith(disposable);

                ViewModel
                    .WhenAny((vm) => vm.CurrentResources, (x) => x)
                    .Subscribe(
                        (cr) =>
                        {
                ...
                this.WhenAnyValue(
                        (v) => v.ViewModel.CurrentPolicy,
                        (v) => v.ViewModel.CurrentResources
                    )
                ...
                this.Bind(ViewModel, (vm) => vm.SearchTerm, (v) => v.SearchBox.Text)
                    .DisposeWith(disposable);
    ...
    private void AdmxAdmlContextButton_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        if (dlg.ShowDialog().GetValueOrDefault())
        {
            ViewModel.OpenFileCommand.Execute(
                new AdmxAndAdmlFiles(dlg.ViewModel.AdmxFilePath, dlg.ViewModel.AdmlFilePaths)
            );
        }
    }
    ...
    {
        var w = new OMAViewer(
            ViewModel.ConfiguredPolicies.ToList(),
            ViewModel.PolicyDefinitionsContent,
