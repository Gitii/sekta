...
namespace Sekta.Core.ModelView.Presentation
{
    public class ConfiguredPolicy : ReactiveObject
    {
        ...
        {
            return JsonConvert.DeserializeObject<List<ConfiguredPolicy>>(strPolicyList,
        ...
        private class ConfiguredPolicyConverter : JsonConverter<ConfiguredPolicy>
        {
            ...
            public override ConfiguredPolicy ReadJson(JsonReader reader, Type objectType,
                ConfiguredPolicy existingValue, bool hasExistingValue,
