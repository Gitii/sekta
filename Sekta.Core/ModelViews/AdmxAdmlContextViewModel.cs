...
namespace Sekta.Core.ModelView
{
    public class AdmxAdmlContextViewModel : ReactiveObject
    {
        ...
        public AdmxAdmlContextViewModel()
        {
            ...
            RemoveSelectedAdmlFileCommand = ReactiveCommand.CreateFromTask(RemoveSelectedAdmlFile,
        ...
        private async Task AddAdmlFile()
        {
            ...
            var files = await service.SelectMultipleInputFiles(new DialogFileFilter("Schema Resource File", "*.adml"));
