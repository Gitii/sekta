...
public class DeserializationLog
{
    ...
    private void OnUnreferencedObject(object sender, UnreferencedObjectEventArgs args)
    {
        LogWarning(
            0,
            0,
            "Unreferenced Object:" + args.UnreferencedId + "\t" + args.UnreferencedObject.ToString()
        );
    }
    ...
    private void OnUnknownElement(object sender, XmlElementEventArgs args)
    {
        LogWarning(
            args.LineNumber,
            args.LinePosition,
            "Unknown Element:" + args.Element.Name + "\t" + args.Element.InnerXml
        );
    }
    ...
    private void OnUnknownAttribute(object sender, XmlAttributeEventArgs args)
    {
        ...
        LogWarning(
            args.LineNumber,
            args.LinePosition,
            $"Unknown attribute {attr.Name}=\'{attr.Value}\'"
        );
    }
