    ...
    public partial class PolicyDefinitionResources
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((_serializer == null))
                {
                    _serializer = new XmlSerializerFactory().CreateSerializer(typeof(PolicyDefinitionResources));
                }
        ...
        public static async Task<(PolicyDefinitionResources, DeserializationLog)> DeserializeAsync(Stream s)
        {
            ...
            try
            {
                ...
                await Task.Run(() => resources = (PolicyDefinitionResources) Serializer.Deserialize(reader));
            }
            catch (Exception e)
            {
                log.Entries.Add(new DeserializationLog.LogEntry(DeserializationLog.LogEntryLevel.Error, 0, 0, e.Message));
            }
            finally
            {
